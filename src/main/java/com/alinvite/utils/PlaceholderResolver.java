...
public class PlaceholderResolver {
    ...
    public CompletableFuture<Map<String, String>> resolveAllPlaceholders(Player player) {
        ...
        return CompletableFuture.allOf(codeFuture, bindFuture, inviterFuture, totalFuture, giftFuture, hasGiftFuture, nextMilestoneFuture, totalRebateFuture, contributionFuture)
            .thenApply(v -> {
